...
class Settings01photoWidget extends StatefulWidget {
  const Settings01photoWidget({Key? key}) : super(key: key);

  @override
  _Settings01photoWidgetState createState() => _Settings01photoWidgetState();
}

class _Settings01photoWidgetState extends State<Settings01photoWidget> {
                      ...
                      child: Container(
                        ...
                        child: Stack(
                          children: [
                            ...
                            Align(
                              alignment: AlignmentDirectional(0.13, 0.61),
                              child: FaIcon(
